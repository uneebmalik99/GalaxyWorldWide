...
class AppUrlCollection extends Component {
  ...
  // New Url 
  static BASE_URL = "http://newsystem.galaxyshipping.tech/webapi/";

  // static BASE_URL = 'https://customer.afgglobalshipping.com/webapi/';
  ...
  static VEHICLE_CREATE = AppUrlCollection.BASE_URL+ "vehicle/create"
  ...
  static DELETE_VEHICLE_IMAGES = AppUrlCollection.BASE_URL + "vehicle/delete-image";
  ...
  static CONTAINER_TRACKING_VIEW =
    AppUrlCollection.BASE_URL + "search/export-view?";
  ...
  static VEHICLE_TRACKING_DETAIL =
    AppUrlCollection.BASE_URL + "search/vehicle-view?";

  static DOWNLOAD_BILLE =
    AppUrlCollection.BASE_URL + "export/billofladng-download?";
  static DOWNLOAD_MAINFEST =
    AppUrlCollection.BASE_URL + "export/manifest-download?";

  static FORGOT_PASSWORD = AppUrlCollection.BASE_URL + "user/forgot-password";

  static MYVEHICLE = AppUrlCollection.BASE_URL + "vehicle?";

  static CHANGE_PASSWORD = AppUrlCollection.BASE_URL + "user/update-password";

  static PAYMENT_HISTORY =
    AppUrlCollection.BASE_URL + "invoice/payment-history";

  static DOWNLOAD_INVOICE = AppUrlCollection.BASE_URL + "invoice/download?";

  static GET_COUNTER =
    AppUrlCollection.BASE_URL + "vehicle/get-vehicle-counter";
