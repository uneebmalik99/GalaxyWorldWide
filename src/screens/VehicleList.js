...
class vehicleList extends Component {
  constructor(props) {
    console.log("yha ata ha", props.route.params.type);
    super(props);
    ...
    this.state = {
      ...
      locationId: props.route.params.loc,
  ...
  return(
    ...
    // return (
    //   <View
    //     colors={["#91C7A5", "#91C7A5", "white", "#91C7A5", "#91C7A5"]}
    //     style={{
    //       height: 130,
    //       width: "100%",
    //       marginTop: 15,
    ...
    //          {strings.Lot_no}: {item.lot_number}
    //         </Text>
    //         <Text style={{ color: "black", fontSize: 12 }}>
    //          {strings.Vin_no}: {item.vin}
    //         </Text>
    //         <Text style={{ color: "black", fontSize: 12 }}>
    //           {strings.Auction} : {item.auction_name}
    //         </Text>
    //         <Text style={{ color: "black", fontSize: 12 }}>
    //           {strings.Purchase_date}: {item.purchase_date}
    //         </Text>
    //       </View>
    //     </TouchableOpacity>
    //     <View
    ...
    //         item.keys != "" &&
    //         item.keys == "1" ? (
    //           <MaterialCommunityIcons name="check-box-outline" color="green" />
    //         ) : (
    //           <MaterialCommunityIcons name="close-box-outline" color="red" />
    //         )}
    //       </Text>
    //     </View>
    //   </View>
  ...
  renderMyTablayout = () => {
    ...
    for (let index = 0; index < this.state.locationList.length; index++) {
      ...
      locationTabGenrate.push(
        ...
        //   <DotIndicator color="white" size={40} />
        //   </View>
        // )
      );
    }
        ...
        >
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              <Text style={styles.modalText}>acaad</Text>
